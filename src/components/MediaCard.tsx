    ...
    <>
      ...
      >
        <div className="relative aspect-video bg-zinc-800 flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-blue-600/20 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 flex items-center justify-center gap-4 backdrop-blur-[2px]">
            <button 
              onClick={() => setIsPreviewOpen(true)}
              className="p-3 bg-white text-blue-600 rounded-full shadow-xl shadow-blue-500/40 hover:scale-110 active:scale-95 transition-all"
            >
        ...
        <div className="p-5 flex flex-col flex-grow">
          <div className="flex justify-between items-start mb-3">
            <h3 className="font-bold text-sm line-clamp-1 flex-grow group-hover/card:text-blue-400 transition-colors" title={media.name}>
              {media.name}
            </h3>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button 
              onClick={() => setIsPreviewOpen(true)}
              className="flex flex-col items-center gap-1.5 p-2 rounded-xl hover:bg-blue-500/10 transition-all text-zinc-500 hover:text-blue-400 group/btn"
            >
              ...
              <div className="flex flex-col md:flex-row h-full max-h-[90vh]">
                ...
                <div className="w-full md:w-80 p-6 flex flex-col border-t md:border-t-0 md:border-l border-zinc-800">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-[10px] rounded uppercase font-bold tracking-wider">
                      {media.type}
                    </span>
